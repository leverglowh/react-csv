  ...
  _createClass(CSVLink, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          leadingComments = _props.leadingComments;

      this.setState({
        href: this.buildURI(data, uFEFF, headers, separator, enclosingCharacter, leadingComments)
      });
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props !== prevProps) {
        var _props2 = this.props,
            ...
            leadingComments = _props2.leadingComments;
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          ...
          leadingComments = _props4.leadingComments,
          rest = _objectWithoutProperties(_props4, ["data", "headers", "separator", "filename", "uFEFF", "children", "onClick", "asyncOnClick", "enclosingCharacter", "leadingComments"]);
