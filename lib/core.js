...
var joiner = exports.joiner = function joiner(data) {
  ...
  return data.filter(function (e) {
    ...
    return row.map(function (element) {
      var el = typeof element === "undefined" || element === null ? "" : element;
      return "" + enclosingCharacter + el + enclosingCharacter;
    }).join(separator);
  }).join("\n");
};
...
var formatComments = function formatComments(leadingComments) {
  var lines = leadingComments.split("\n");

  lines = lines.reduce(function (memo, line) {
    if (line) {
      var l = line.trim();
...
var toCSV = exports.toCSV = function toCSV(data, headers, separator, enclosingCharacter, leadingComments) {
...
var buildURI = exports.buildURI = function buildURI(data, uFEFF, headers, separator, enclosingCharacter, leadingComments) {
